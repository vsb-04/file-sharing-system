  ...
  return (
    <div>
      ...
      <div className="animate-section">
        <h2 className="animate-heading">What is LibroLink ?</h2>
        <p className="animate-para">
          LibroLink is a decentralized file storage system that uses
          ...
          LibroLink, data management becomes decentralized and transparent, a
      ...
      <div className="about">
        ...
        <p className="about-text">
          At LibroLink, we believe that data ownership and privacy are
      ...
      <div className="footer-section">
        <div className="column1">
          ...
          <p className="column1-para">librolink@gmail.com</p>
        </div>
        ...
        <div className="column3">
          <p className="Column3-text">
            © 2023 LibroLink. All rights reserved
          </p>
        </div>
      </div>
    </div>
